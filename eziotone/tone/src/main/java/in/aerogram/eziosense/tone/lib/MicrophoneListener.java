    ...
    public void run() {
    	...
    	try {
    	   ...
    	   */
    	    ...
    	    int buffSize = (int) Constants.kSamplingFrequency
    	    						* 2 // 2 seconds in the buffer
    	    						* 2; // recording in 16 bit
    	    
    	    int biteSize = ((int) Constants.kSamplingFrequency ) / 8;  // move 1/8 sec of data at a time
    	    
    	    AudioRecord arec = new	AudioRecord(MediaRecorder.AudioSource.MIC,
    	    		(int) Constants.kSamplingFrequency, //11025,
